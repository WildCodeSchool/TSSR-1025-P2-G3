    ...
    switch ($addUserMenu) {
        ...
        1 {
            ...
            while ($UserCreationChoice -eq "o") {
                ...
                $userExists = bash_command "grep ''^${addUserCommand}:'' /etc/passwd"
                ...
                if (-not $userExists) {
                    ...
                    if ($ConfirmUser -eq "o") {
                        ...
                        bash_sudo_command "useradd -m ${addUserCommand}"
    ...
    switch ($delUserMenu) {
        ...
        1 {
            ...
            while ($delAnotherUser -eq "o") {   
                ...
                $userExists = bash_command "grep '^${delUserCommand}:' /etc/passwd"
                ...
                if ($userExists) {
                    ...
                    if ($confirmDelUser -eq "o") {
                        ...
                        $userDeleted = bash_command "grep ''^${addUserCommand}:'' /etc/passwd"
        ...
        1 {
            ...
            while ($changeAnotherPassword -eq "o") {
                ...
                if ($userExists) {
                    ...
                    $hashedPassword = bash_command "openssl passwd -6 '${newPassword}'"
                    bash_sudo_command "usermod -p '${hashedPassword}' ${changePasswordUserCommand}"
